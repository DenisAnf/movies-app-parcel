 ...
 */const b=function(e){// TODO(user): Use native implementations if/when available
 ...
 */const S=function(e){let t=b(e);return T.encodeByteArray(t,!0)},I=function(e){// Use base64url encoding and remove padding in the end (dot characters).
...
setLogLevel(e){this._logLevel="string"==typeof e?H[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,eV.DEBUG,...e),this._logHandler(this,eV.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,eV.VERBOSE,...e),this._logHandler(this,eV.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,eV.INFO,...e),this._logHandler(this,eV.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,eV.WARN,...e),this._logHandler(this,eV.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,eV.ERROR,...e),this._logHandler(this,eV.ERROR,...e)}}const Y=(e,t)=>t.some(t=>e instanceof t),J=new WeakMap,Z=new WeakMap,ee=new WeakMap,et=new WeakMap,en=new WeakMap;let er={get(e,t,n){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const ec="@firebase/app",ed="0.9.22",ef=new X("@firebase/app"),eg="[DEFAULT]",ep={[ec]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},em=new Map,ey=new Map;/**
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const il=new X("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
...
t.push(...n.split("/").filter(e=>e.length>0))}return new iL(t)}static emptyPath(){return new iL([])}}const iO=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 */function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new iZ(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return iD(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}iZ.EMPTY_BYTE_STRING=new iZ("");const i0=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sQ=new iH(iP.comparator),sW=new iH(iP.comparator);function sX(...e){let t=sW;for(let n of e)t=t.insert(n.key,n);return t}function sY(){return new sG(e=>e.toString(),(e,t)=>e.isEqual(t))}new iH(iP.comparator);const sJ=new iW(iP.comparator);function sZ(...e){let t=sJ;for(let n of e)t=t.add(n);return t}const s0=new iW(iD);/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const am=new ii([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
...
r.xe(t),this.Qe=this.Qe.insert(t,this.ot(t).delete(e)),n&&(this.qe=this.qe.insert(t,n))}removeTarget(e){this.ke.delete(e)}/**
     ...
     * specified target.
     */st(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function aD(){return new iH(iP.comparator)}function ak(){return new iH(iP.comparator)}const aN={asc:"ASCENDING",desc:"DESCENDING"},aR={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},ax={and:"AND",or:"OR"};/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oy="WebChannelConnection";class ov extends /**
 ...
 */const lO=RegExp("[~\\*/\\[\\]]");function lM(e,t,n,r,i){let s=r&&!r.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${i}`),l+=")"),new iy(im.INVALID_ARGUMENT,o+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
